...
curve(c * 100 * (1 - exp(-a * x)) - x, from = 0, to = 100)
curve(fixef(lvpost)[1] * (1 - fixef(lvpost)[2] * x), add = TRUE)
curve(fixef(rickpost)[1] * exp(-fixef(rickpost)[2] * x), add = TRUE)
```
